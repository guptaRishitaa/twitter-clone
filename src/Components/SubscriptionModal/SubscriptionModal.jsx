            ...
            <div className="w-[80%] space-y-10 hideScrollbar overflow-y-scroll  overflow-x-hidden">
              <div className="p-5 rounded-md flex items-center justify-between bg-slate-400 shadow-lg">
                <h1 className="text-xl pr-5">
                  Blue subscribers get verified if you have a verified phone
                  number
                </h1>
                <img
                  className="w-24 h-24"
                  src="https://img.freepik.com/free-vector/blue-star-check-mark_78370-4478.jpg?t=st=1709682769~exp=1709686369~hmac=d9b20dc82249e91b9b7e8291be31a7dd213a8e70b93318126a0bc0e78b873757&w=740"
                  alt=""
                ></img>
              </div>
              ...
              <div onClick={makePayment} className="cursor-pointer flex justify-center bg-gray-900 text-white rounded-full px-5 py-3">
